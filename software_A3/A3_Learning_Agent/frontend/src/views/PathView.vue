...
async function renderMarkmaps(){
  ...
  for(const s of stages.value){
    for(const r of s.resources||[]){
      ...
      const options={duration:260,maxWidth:280,spacingVertical:12,spacingHorizontal:88,color:(node)=>['#2563eb','#7c3aed','#16a34a','#f97316'][node.state.depth%4]||'#64748b'};
