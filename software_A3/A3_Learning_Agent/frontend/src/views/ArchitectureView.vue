  ...
  <div class="page architecture-page">
    ...
    <el-card class="panel">
      ...
      <el-steps :active="6" finish-status="success" align-center>
        ...
        <el-step title="资源生成" description="Text/Quiz/Visual/Code/Video" />
...
const agents = [
  ...
  { name: "TextAgent", role: "讲解文档生成师", input: "画像 + 教材依据", output: "课程讲解、拓展阅读", value: "生成文本类资源" },
  { name: "QuizAgent", role: "分层练习设计师", input: "画像 + 知识点", output: "基础/提升/应用练习", value: "生成题库资源" },
  { name: "VisualAgent", role: "可视化学习设计师", input: "教材片段", output: "思维导图、图解方案", value: "生成可视化资源" },
...
const requirements = [
  ...
  { title: "多智能体协同资源生成", desc: "协作生成课程讲解文档、思维导图、练习题、拓展阅读、教学视频/动画、代码实操案例等 6 类资源。", tags: ["TextAgent", "QuizAgent", "VisualAgent", "CodeAgent", "VideoAgent"], done: true },
