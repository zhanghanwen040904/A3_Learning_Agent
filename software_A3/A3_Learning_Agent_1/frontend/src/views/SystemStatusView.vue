        ...
        <el-card class="panel status-card">
          ...
          <el-descriptions :column="1" border>
            <el-descriptions-item label="当前模式">
              <el-tag :type="status.ai?.mock_ai ? 'warning' : 'primary'" effect="plain">{{ status.ai?.mode || '-' }}</el-tag>
            </el-descriptions-item>
      ...
      <el-card v-if="aiResult" class="result-card" shadow="never">
        <el-descriptions :column="1" border>
          <el-descriptions-item label="测试模式">
            <el-tag :type="aiResult.mock_ai ? 'warning' : 'primary'" effect="plain">{{ aiResult.mode }}</el-tag>
          </el-descriptions-item>
