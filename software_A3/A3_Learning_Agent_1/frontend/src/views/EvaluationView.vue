    ...
    <el-card class="panel">
      ...
      <div class="profile-box">
        ...
        <el-space wrap>
          ...
          <el-tag v-if="summary.profile?.study_goal" type="primary" effect="plain">目标：{{ summary.profile.study_goal }}</el-tag>
        ...
        <div v-else class="question-list">
          <div v-for="question in questions" :key="question.id" class="question-card">
            <div class="question-meta">
              ...
              <el-tag v-if="question.result" :type="question.result.score >= 75 ? 'primary' : 'warning'" effect="plain">
