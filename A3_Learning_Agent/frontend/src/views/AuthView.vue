      ...
      <section class="illustration-panel">
        ...
        <svg class="learning-illustration" viewBox="0 0 760 560" role="img" aria-label="学生与 AI 学习助手协作的原创插画">
          ...
          <g filter="url(#softShadow)">
            ...
            <circle class="dot blue" cx="268" cy="143" r="7" />
            <circle class="dot orange" cx="292" cy="143" r="7" />
            <rect class="code-line blue-fill" x="252" y="204" width="126" height="12" rx="6" />
          ...
          <g class="student student-left">
            ...
            <path class="body blue-fill" d="M104 424 C112 354 132 324 166 324 C202 324 224 354 232 424 Z" />
          ...
          <g class="student student-right">
            ...
            <path class="body deep-blue-fill" d="M532 426 C540 362 560 334 594 334 C628 334 648 362 656 426 Z" />
...
.login-form :deep(.el-input__wrapper.is-focus) {
  box-shadow: 0 0 0 1px var(--blue) inset, 0 0 0 3px rgba(56, 189, 248, .18);
}
